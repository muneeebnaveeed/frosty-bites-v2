!(function (e, t) {
   ...
   const c = /^0o[0-7]+$/i;
   const s = parseInt;
   const u = typeof e === 'object' && e && e.Object === Object && e;
   const d = typeof self === 'object' && self && self.Object === Object && self;
   const l = u || d || Function('return this')();
   ...
   const N = /^0o[0-7]+$/i;
   const z = parseInt;
   const C = typeof e === 'object' && e && e.Object === Object && e;
   const A = typeof self === 'object' && self && self.Object === Object && self;
   const q = C || A || Function('return this')();
   ...
   const ee = function (e, t, n) {
      const o = e.getAttribute(`data-aos-${t}`);
      if (void 0 !== o) {
         if (o === 'true') return !0;
         if (o === 'false') return !1;
      }
   ...
   const te = function (e, t) {
      return (
         e.forEach(function (e, n) {
            const o = ee(e.node, 'mirror', t.mirror);
            const i = ee(e.node, 'once', t.once);
            const a = ee(e.node, 'id');
            const r = t.useClassNames && e.node.getAttribute('data-aos');
            const c = [t.animatedClassName].concat(r ? r.split(' ') : []).filter(function (e) {
            ...
            t.initClassName && e.node.classList.add(t.initClassName),
               (e.position = {
                  in: (function (e, t, n) {
                     ...
                     const i = ee(e, 'anchor');
                     const a = ee(e, 'anchor-placement');
                     const r = Number(ee(e, 'offset', a ? 0 : t));
                     const c = a || n;
                     let s = e;
         ...
         return (
            ...
            de(ae.disable) || re()
               ...
               : (document.querySelector('body').setAttribute('data-aos-easing', ae.easing),
                 ...
                 ['DOMContentLoaded', 'load'].indexOf(ae.startEvent) === -1
                 ...
                 ae.startEvent === 'DOMContentLoaded' &&
