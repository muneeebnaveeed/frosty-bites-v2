...
!(function (t, e) {
   ...
   function b(t, i) {
      ...
      const n = { top: l, height: i.railYHeight };
   ...
   const w = { isEmpty: { configurable: !0 } };
   (X.prototype.bind = function (t, e) {
      ...
      (X.prototype.unbindAll = function () {
         const t = this;
         for (const e in t.handlers) t.unbind(e);
      }),
   ...
   const W = function (t, e, i, r, l) {
      void 0 === r && (r = !0), void 0 === l && (l = !1);
      let n;
      if (e === 'top') n = ['contentHeight', 'containerHeight', 'scrollTop', 'y', 'up', 'down'];
      else {
         if (e !== 'left') throw new Error('A proper axis should be provided');
   ...
   var R = function (t) {
      const e = t.element;
      const i = Math.floor(e.scrollTop);
   ...
   const T = {
      ...
      keyboard(t) {
         function e(e, r) {
            const l = Math.floor(i.scrollTop);
            if (e === 0) {
         ...
         t.event.bind(t.ownerDocument, 'keydown', function (r) {
            if (!((r.isDefaultPrevented && r.isDefaultPrevented()) || r.defaultPrevented) && (l() || n())) {
               ...
               if (o) {
                  if (o.tagName === 'IFRAME') o = o.contentDocument.activeElement;
      ...
      wheel(e) {
         function i(t, i) {
            const r = Math.floor(o.scrollTop);
            const l = o.scrollTop === 0;
            const n = r + o.offsetHeight === o.scrollHeight;
            const s = o.scrollLeft === 0;
            const a = o.scrollLeft + o.offsetWidth === o.scrollWidth;
         ...
         function l(e, i, r) {
            ...
            for (let l = e; l && l !== o; ) {
               ...
               if ([n.overflow, n.overflowX, n.overflowY].join('').match(/(scroll|auto)/)) {
                  ...
                  if (s > 0 && !((l.scrollTop === 0 && r > 0) || (l.scrollTop === s && r < 0))) return !0;
                  const a = l.scrollWidth - l.clientWidth;
                  if (a > 0 && !((l.scrollLeft === 0 && i < 0) || (l.scrollLeft === a && i > 0))) return !0;
               }
               l = l.parentNode;
            }
            return !1;
      ...
      touch(e) {
         function i(t, i) {
            const r = Math.floor(h.scrollTop);
            ...
            } else if (n > o && ((t < 0 && l === e.contentWidth - e.containerWidth) || (t > 0 && l === 0))) return !0;
            return !0;
         }
         function r(t, i) {
         ...
         function s(e, i, r) {
            ...
            for (let l = e; l && l !== h; ) {
               ...
               if ([n.overflow, n.overflowX, n.overflowY].join('').match(/(scroll|auto)/)) {
                  ...
                  if (o > 0 && !((l.scrollTop === 0 && r > 0) || (l.scrollTop === o && r < 0))) return !0;
                  const s = l.scrollLeft - l.clientWidth;
                  if (s > 0 && !((l.scrollLeft === 0 && i < 0) || (l.scrollLeft === s && i > 0))) return !0;
               }
               l = l.parentNode;
            }
            return !1;
   ...
   const H = function (r, l) {
      ...
      for (const o in l) n.settings[o] = l[o];
